        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ Auth::user()->avatar ? asset( Auth::user()->avatar ) : url('storage/placeholder/avatar/default-profile.png')}}" class="user-img" alt="user avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">{{ Auth::guard('web')->user()->name ?? Auth::guard('admin')->user()->name }}</p>
                        <p class="designattion mb-0">{{ Auth::guard('web')->user()->user_role->name ?? 'Administrator' }}</p>
                    </div>
                </a>
