                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" action="{{ route('user.register.store') }}"
                                            method="POST">
                                            @csrf
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select class="form-control" id="inputSelectRole" placeholder=""
                                                    name="user_role_id">
                                                    @foreach ($userRole as $id => $name)
                                                        <option value="{{ $id }}"
                                                            @if (@$value == $id) selected @endif>
                                                            {{ $name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <a class="btn btn-success" href="{{ route('login.index') }}"><i
